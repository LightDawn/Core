...
namespace Core.Mvc.Helpers.Lookup
{
...

    {
        ...
        public RefahKendoGrid.Settings.GridInfo GridInfo { get; set; }

        public RefahKendoGrid.ClientDependentFeature ClientDependentFeatures { get; set; }
    ...
    public interface ILookupView
    {
        ...
        string ViewModelProperty { get; set; }
