...
namespace Core.Mvc.Helpers
{
    public class TreeView : TreeViewBase, IEssentialItem<TreeViewItem>
    {
            ...
            : base(viewContext, initializer)
        {
            ...
            if (info.DataSource.ModelRP.ModelType.Equals(typeof(TreeViewModelBase)))
            {
            ...
            this.DataSource = new TreeViewDataSource(info, this.Name, info.DataSource.ModelRP.ModelType);
