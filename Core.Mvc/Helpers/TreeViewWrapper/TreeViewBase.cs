...
namespace Core.Mvc.Helpers
{
    public abstract class TreeViewBase
    {
        ...
        protected TreeViewBase(System.Web.Mvc.ViewContext viewContext, ViewDataDictionary viewData = null)
        {
        ...
        public virtual void VerifySettings()
        {
            ...
            {
                throw new InvalidOperationException(Core.Resources.ExceptionMessage.NameCantBeEmpty);
            }
            if (!this.Name.Contains("<#=") && (this.Name.IndexOf(" ") != -1))
            {
                throw new InvalidOperationException(Core.Resources.ExceptionMessage.NameCannotContainsWhiteSpace);
            }
