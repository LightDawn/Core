...
namespace Core.Mvc.Helpers
{
    public static class BundlesHelper
    {
        ...
        public static IHtmlString ScriptRP(this HtmlHelper helper, string fileName)
        {
        ...
        public static IHtmlString ScriptRP(this HtmlHelper helper)
        {
            return ScriptRP(helper, string.Empty);
        }
