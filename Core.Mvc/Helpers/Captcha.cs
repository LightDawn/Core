...
namespace Core.Mvc.Helpers
{
    public static class Captcha
    {
        ...
        public static MvcHtmlString CaptchaRP(this HtmlHelper helper, string captchaTextBoxName)
        {
            ...
            <div>
                    <div style='float:right;'>
                        ...
                        <img id='imgCaptchaLoading' src='" + urlHelper.Content("~/Content/Images/CaptchaLoading.gif") + @"' alt='در حال بارگذاری' />
            ...
            container.InnerHtml = commentPart + helper.TextBoxRP(captchaTextBoxName).ToHtmlString() + captchaTag;
